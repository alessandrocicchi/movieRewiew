    ...
    ReturnImage(){
      ...
      for (let i = 0; i < this.films.length; i++) {
        ...
        if (this.id==this.films[i].id) {
          ...
          return "https://image.tmdb.org/t/p/w500" + this.films[i].backdrop_path
...
<div class="container tabella">
    <div class="col-12">
      ...
      <div class="row">
            <div class="col-6 colonna"> 
              Titolo:{{ ReturnTitle }}
            </div>
            <div class="col-6 colonna">
              Popolarità: {{ ReturnPopularity }} %  
            </div>
      </div>
    <div class="row">
      <div class="col">
...
<!--,
  mounted(){
        ...
        .then(response => console.log(this.$route.params.data))
    }-->
